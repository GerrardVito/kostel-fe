...
import { Users, CheckCircle, XCircle, Eye, Clock, ChevronRight, Loader2, Building2, AlertTriangle, Check, BedDouble } from "lucide-react";
  ...
  return (
    <>
      ...
      {selectedApp && (
        <Modal
          size="lg"
          onClose={() => { setSelectedApp(null); setErrorMsg(""); }}
